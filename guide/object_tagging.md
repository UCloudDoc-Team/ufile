...
US3支持使用标签对存储空间（Bucket）中的对象（Object）进行分类，用户可以针对同标签的对象设置生命周期规则。生命周期相关请访问 [生命周期](https://docs.ucloud.cn/ufile/guide/lifecycle?id=%e7%ae%a1%e7%90%86%e7%94%9f%e5%91%bd%e5%91%a8%e6%9c%9f) 。目前对象标签支持越南、巴西，俄罗斯，北京，乌兰察布，上海，香港。如其他地域有需要，请联系技术支持。
