...
本文介绍 US3 对象存储服务**后付费**的计费项和定价标准，US3 定价会因[存储类型](/ufile/introduction/storage_type) 和 [地域](/ufile/introduction/region) 有所不同，当前地域定价分为“中国大陆”及“香港、台湾（台北）及海外”两部分。
...
**目前 US3 中国大陆的可用区包括：华北（北京2）、华北（乌兰察布）、华东（上海2）、华南（广州）。**<br>
...
**目前 US3 香港、台湾（台北）及海外的可用区包括：香港、美国（洛杉矶）、新加坡、印度尼西亚（雅加达）、台湾（台北）、尼日利亚（拉各斯）、巴西（圣保罗）、阿联酋（迪拜）、德国（法兰克福）、越南（胡志明）、美国（华盛顿）、印度（孟买）、日本（东京）、韩国（首尔）、泰国（曼谷）、英国、俄罗斯（莫斯科）**

> **注意：**
>
>1. 【图片处理】从2022年7月1号开始计费；
>2. 当前归档类型可用区仅限中国大陆（华北（北京2）、华北（乌兰察布）、上海、华南（广州））；
